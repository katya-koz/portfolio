        ...
        {items.map((n, index) => (
          <>
            ...
            <div className="relative flex flex-col md:flex-row items-start">
              <div className="absolute w-5 h-5 bg-teal-300 rounded-full border-4 border-white z-10"></div>
              <div className="md:w-3/4 mt-4 md:mt-0 md:pl-8">
                ...
                <div className="flex items-center space-x-4 bg-white rounded-lg m-2 p-4 shadow-md">
                  <img
                    src={n.logoSrc}
                    alt={`${n.title} Logo`}
                  ...
                  <div>
                    ...
                    <h3 className="text-gray-700 italic">{n.title}</h3>
                  </div>
                </div>
              </div>
            </div>
